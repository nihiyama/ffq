...
func BenchmarkJSONSimpleQueueEnqueueDequeue(b *testing.B) {
...
func BenchmarkJSONSimpleQueueBulkEnqueueDequeue(b *testing.B) {
	var size uint64 = 100
...
func BenchmarkJSONSimpleQueueEnqueueDequeue_5MP(b *testing.B) {
	for _, tt := range tests {
		b.Run(fmt.Sprintf("Size%d", tt), func(b *testing.B) {
			dir, _ := os.MkdirTemp("", "ffqbenchtest")
			data := createData(tt)
...
func BenchmarkJSONSimpleQueueBulkEnqueueDequeue_5MP(b *testing.B) {
	var size uint64 = 100
	lazy := 10 * time.Millisecond
	for _, tt := range tests {
		b.Run(fmt.Sprintf("Size%d", tt), func(b *testing.B) {
...
func BenchmarkJSONGroupQueueEnqueueDequeue_5Group(b *testing.B) {
...
func BenchmarkJSONGroupQueueBulkEnqueueDequeue_5Group(b *testing.B) {
	testQueues := []string{"queue1", "queue2", "queue3", "queue4", "queue5"}
	size := 100
	lazy := 10 * time.Millisecond
	for _, tt := range tests {
